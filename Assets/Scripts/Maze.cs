...
public class Maze : MonoBehaviour
{
    ...
    MazeCell[,] cells = new MazeCell[WIDTH, HEIGHT]
    {
        ...
        {new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = false, leftWall = false, bottomWall = true,}, },
        ...
        {new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = true, leftWall = true, bottomWall = false,}, new MazeCell{growsFood = true, leftWall = false, bottomWall = true,}, new MazeCell{growsFood = false, leftWall = false, bottomWall = true,}, },
